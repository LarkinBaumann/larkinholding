...
function Hero() {
  return (
    ...
    <div className='w-full h-full flex flex-col justify-center'>
      ...
      <h2 className='text-white font-roboto text-8xl font-bold leading-[87.55px] titulo'>
        Investment & Finances
      </h2>
      <p className='text-white font-roboto text-xl font-semibold leading-[38.726px]'>
