...
function Empresas() {
  ...
  useEffect(() => {
    if (loadedImages.length === traduccion.empresas.length) {
...
>
      ...
      />
        ...
        <motion.div
          className="hidden lg:grid grid-cols-8 w-full h-full px-14 items-center gap-9 max-w-[1444px] mx-auto min-w-sm "
          initial="hidden"
          animate={inView ? "visible" : "hidden"}
          variants={containerVariants}
        >
          {traduccion.empresas.map((empresa, index) => (
            ...
            >
              ...
              <svg
                className={
                  seleccion != index
                    ? "lg:w-[108px] lg:h-[47%] xl:w-[88px] xl:h-[300px] absolute  bottom-0 flex flex-row justify-center items-center text-left"
                    : "hidden"
                }
                xmlns="http://www.w3.org/2000/svg"
                width="87"
